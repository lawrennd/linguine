# Linguine: A Specification for Data-Oriented Interfaces

Linguine is a **specification** for defining data-oriented interfaces using YAML configuration files. It provides a standardized format for describing how data should be accessed, processed, and presented across different implementations.
